...
if machine_code in hash_values_list:
    ...
    print("Oxirgi kod yanilangan vaqti 11.03.2025 3:55 AM")
    phonecsv = "spamemas"
    ...
    for deltaxd in phlist[qowiwjm:qowiwjm2]:
        try:
            ...
            async def main():
                ...
                response =  http_client.post(url="https://gifts2.tonnel.network/api/balance/info", json=jsondata, headers=headers, timeout=10)
                if response.ok:
                ...
                for giveaway_code in giv_ids_ozim:
                    ...
                    response =  http_client.post(url="https://gifts2.tonnel.network/api/giveaway/info", headers=headers, json=jsondata, timeout=20)
