...
if machine_code in hash_values_list:
    ...
    with open(r"/storage/emulated/0/giv/tonnelochiqkanal.csv", 'r') as f:
        ...
        try:
            ...
            async def main():
                ...
                for giveaway_code in giv_ids_ozim:
                    ...
                    # response = requests.post("https://gifts2.tonnel.network/api/giveaway/info", headers=headers, json=jsondata, timeout=10)
                    ...
                    #     print(f"TUGASH VAQTI - {deadline}")
                    #     print(f"Chats - {chat}")
                    #     print(f"QATNASHAYOTGANLAR SONI - {participated}")
                    #     print(f"YUTUQLAR SONI - {giftlarsoni}")
                    #     print(f"YUTGANLAR - {winners}")
                    #     print(f"KIM QOSHILA OLADI - {eligibility_criteria}")
